<template>
    <div class="contacts container">
        <div class="contact-link">
            <h1>Контакты</h1>
            <div class="contact-link-item shadow">
                <div>
                    <h4 class="azor-marker">Адрес</h4>
                    <a href="https://go.2gis.com/mic7n">г. Бишкек, ул. Уметалиева 127</a>
                </div>
                <div>
                    <h4 class="azor-phone">Номер телефона</h4>
                    <a href="tel:+996 550 050 060">+996 550 050 060</a>
                </div>
                <div>
                    <h4 class="azor-mail">Почта</h4>
                    <a href="mailto:info@azor.kg">info@azor.kg</a>
                </div>
                <social-bar/>
            </div>
        </div>
